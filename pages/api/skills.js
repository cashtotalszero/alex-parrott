import { SKILL_NAMES, SKILL_TYPES, SKILL_LEVELS } from '../../constants/skills';
...
const dataDefs = [
  ...
  { name: SKILL_NAMES.JEST, level: SKILL_LEVELS.HALO, type: SKILL_TYPES.TEST, lang: JS },
  { name: SKILL_NAMES.ENZYME, level: SKILL_LEVELS.HALO, type: SKILL_TYPES.TEST, lang: JS },
  { name: SKILL_NAMES.MOCHA, level: SKILL_LEVELS.HALO, type: SKILL_TYPES.TEST, lang: JS },
  { name: SKILL_NAMES.CHAI, level: SKILL_LEVELS.HALO, type: SKILL_TYPES.TEST, lang: JS },
  {
    name: SKILL_NAMES.TS,
    level: SKILL_LEVELS.SMILE,
    type: SKILL_TYPES.LANGUAGES,
  ...
  { name: SKILL_NAMES.SASS, level: SKILL_LEVELS.HALO, type: SKILL_TYPES.LIB, lang: CSS },
  {
  ...
  {
    name: SKILL_NAMES.AWS,
    level: SKILL_LEVELS.FLUSHED,
    type: SKILL_TYPES.DEV_OPS,
  },
  {
    name: SKILL_NAMES.AZURE,
    level: SKILL_LEVELS.FLUSHED,
    type: SKILL_TYPES.DEV_OPS,
  },
  {
    name: SKILL_NAMES.HTML,
    level: SKILL_LEVELS.HALO,
    type: SKILL_TYPES.LANGUAGES,
    lang: HTML,
  },
  {
    name: SKILL_NAMES.CSS,
    level: SKILL_LEVELS.HALO,
    type: SKILL_TYPES.LANGUAGES,
    lang: CSS,
  },
