...
export const MONKEY_KNIFE_FIGHT = 'https://www.youtube.com/watch?v=yvnmhn-bBo0';
export const CONTRACT_FOR_THE_WEB = 'https://contractfortheweb.org/';
export const REACT_SITE = 'https://reactjs.org/';
export const REACT_NATIVE_SITE = 'https://reactnative.dev/';

export const AFORZA_SITE = 'https://www.aforza.com/';
export const AFORZA_SERIES_A = 'https://techcrunch.com/2021/08/12/consumer-goods-software-company-aforza-bags-22m-to-open-u-s-headquarters/';
export const LLOYDS_BANK_SITE = 'https://www.lloydsbank.com/';
export const RED_7_MOBILE_SITE = 'http://www.red7mobile.com/';
export const SOMO_GLOBAL_SITE = 'https://www.somoglobal.com/';
export const BJSS_SITE = 'https://www.bjss.com/';
export const NATS = 'https://www.nats.aero/';
export const ESA_SUMMER_OF_CODE = 'https://www.esa.int/Enabling_Support/Space_Engineering_Technology/SOCIS_The_ESA_Summer_of_Code_in_Space';
...
export const DADI_AWARD = 'https://www.dadiawards.com/dadi-awards-2018/automotive-website-app-or-campaign/audi-beta-audi-online-re-imagined';
export const AUDI_BETA_BLOG = 'https://content.somoglobal.com/audi_online_re-imagined';
export const A4_APP_IOS = 'https://apps.apple.com/gb/app/audi-a4-virtual-showroom/id1172980354';
